            ...
            <div class="col-md-12">
                ...
                <form action="{{route('customer.update', ['customer' => $customer->id])}}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="no_antrian" id="no_antrian" placeholder="Masukkan No Antrian" class="form-control" value="{{old('no_antrian') ?? $customer->no_antrian}}">
                        @error('no_antrian')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_customer" id="nama_customer" placeholder="Masukkan Nama customer" class="form-control" value="{{old('nama_customer') ?? $customer->nama_customer}}">
                        @error('nama_customer')
                            <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
